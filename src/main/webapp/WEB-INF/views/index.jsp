	 ...
	 <nav class="navbar navbar-default" role="navigation">
	   <div class="container-fluid">
	 	...
	 	<li><a href="#">Все</a></li>
	         ...
	         <li class="dropdown">
	           <a href="#" class="dropdown-toggle" data-toggle="dropdown">По возрастанию <b class="caret"></b></a>
	         ...
	         <li class="dropdown">
	           <a href="#" class="dropdown-toggle" data-toggle="dropdown">Показывать по 10 <b class="caret"></b></a>
	           <ul class="dropdown-menu">
