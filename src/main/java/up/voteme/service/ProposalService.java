...
public interface ProposalService {
	...
	/* 
	   public abstract List<Proposal> getByParams (HashMap<String,String> map);
			...
			!!! ( 1.noSort = showAll; 2. use .equalseIgnoreCase(); 3.hint: int num = Integer.parseInt(..) )
	...
	/* 
	  Also we need:
	  	public abstract List<Region> getByCountryName (String countryName);
	  	public abstract List<City> getByRegionName (String regionName);
	  	public abstract List<District> getByCityName (String cityName);
	 */
