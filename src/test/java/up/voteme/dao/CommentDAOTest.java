...
public class CommentDAOTest {
	...
	public void B_storeTest(){
		...
		List<Comment> beforList = dao.findAll();
		//modify item
		Comment item = dao.findById(1L);
		item.setCommentId(0);
		item.setCommentText("OHOHOHOHOHO");
		
		long id =  dao.store(item);
		List<Comment> afterList = dao.findAll();
