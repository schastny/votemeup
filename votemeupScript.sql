...
CREATE TABLE IF NOT EXISTS `votemeup`.`proposal_category` (
  ...
  INDEX `fk_proposal_category_category1_idx` (`id_category` ASC),
  ...
  CONSTRAINT `fk_proposal_category_category1`
    ...
    REFERENCES `votemeup`.`category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `votemeup`.`proposal_tag` (
  ...
  INDEX `fk_proposal_tag_tag1_idx` (`id_tag` ASC),
  CONSTRAINT `fk_proposal_tag_proposal1`
    FOREIGN KEY (`id_proposal`)
    REFERENCES `votemeup`.`proposal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_proposal_tag_tag1`
    FOREIGN KEY (`id_tag`)
    REFERENCES `votemeup`.`tag` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
