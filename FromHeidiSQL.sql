...
-- Дамп данных таблицы ssvotemeup.comment: ~3 rows (приблизительно)
DELETE FROM `comment`;
...
-- Дамп данных таблицы ssvotemeup.proposal: ~2 rows (приблизительно)
...
-- Дамп данных таблицы ssvotemeup.vote: ~10 rows (приблизительно)
DELETE FROM `vote`;
