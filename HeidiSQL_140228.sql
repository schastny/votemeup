...
-- Дамп данных таблицы votemeup_new.city: ~3 rows (приблизительно)
DELETE FROM `city`;
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  `CommentDelete` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
-- Дамп данных таблицы votemeup_new.district: ~2 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `ReportNewProposal` bit(1) DEFAULT NULL,
  `ReportNewComment` bit(1) DEFAULT NULL,
  `ReportNewCommentAuthor` bit(1) DEFAULT NULL,
  ...
  `ProposalBan` bit(1) DEFAULT NULL,
  `CommentBan` bit(1) DEFAULT NULL,
  `Сountry_id` int(11) NOT NULL,
  `City_id` int(11) NOT NULL,
  `District_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Дамп данных таблицы votemeup_new.user: ~1 rows (приблизительно)
DELETE FROM `user`;
...
CREATE TABLE IF NOT EXISTS `vote_proposal` (
  ...
  `Proposal_id` int(11) NOT NULL,
  `VoteYes` bit(1) DEFAULT NULL,
  `VoteNo` bit(1) DEFAULT NULL,
...
-- Дамп данных таблицы votemeup_new.сountry: ~2 rows (приблизительно)
DELETE FROM `сountry`;
